...
export function TransactionList({ transactions, contacts, rate, title, isRouterNav = false}) {
    return (
        <section className="transaction-list">
            ...
            {transactions.map(transaction => <TransactionPreview key={transaction.at} transaction={transaction} contacts={contacts} rate={rate}  isRouterNav={isRouterNav}/>)}
        </section>
    )
}
